 ...
 * @author namor
 */
public class NewTelaInicial extends javax.swing.JFrame {

    /**
     * Creates new form NewTelaInicial
     */
    public NewTelaInicial() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(873, 530));

        jPanel1.setBackground(new java.awt.Color(235, 191, 16));
        jPanel1.setPreferredSize(new java.awt.Dimension(873, 530));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewTelaInicial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void carregarNovaPaginaGestao() {
        ...
        janela2.setLocationRelativeTo(this);
        janela2.setVisible(true);
        janela2.setResizable(false);
        janela2.setAlwaysOnTop(true);
    }
    
    NewPaginaCliente janela3 = new NewPaginaCliente();
