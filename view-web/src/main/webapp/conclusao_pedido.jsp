...
<head>
    ...
    <title>Sabor e Arte - Conclusão do pedido</title>
</head>
    ...
    <div class="d-flex flex-column wrapper">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <div class="align-self-end">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a href="login.jsp" class="nav-link text-white">Entrar</a>
                            </li>
                            <li class="nav-item">
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <h3> Dirija-se ao caixa para efetuar o pagamento. Depois de concluído o pagamento, aguarde seu pedido em sua mesa. </h3>
            </div>
        </main>
